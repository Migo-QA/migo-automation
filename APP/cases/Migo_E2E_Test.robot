...
Location Test
    ...
    Check Location List
    Log to console Dash  Check Location List Pass

    Log to console Dash  Check Locate
    Check Locate
    Log to console Dash  Check Locate Pass

    Log to console Dash  Check Map Pin
    Check Map Pin
    Log to console Dash  Check Map Pin Pass
